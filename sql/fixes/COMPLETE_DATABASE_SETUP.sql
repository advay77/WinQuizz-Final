-- ============================================
-- COMPLETE DATABASE SETUP FOR WINQUIZZ PRO
...
RETURNS TRIGGER AS $$
BEGIN
  INSERT INTO public.profiles (id, email, phone, role, email_verified, phone_verified)
  VALUES (
    NEW.id,
    NEW.email,
    NEW.phone,
...
-- ============================================
-- SUCCESS! Your database is now set up with:
-- ✅ profiles table with role column
-- ✅ games table with sample data
-- ✅ quizzes table
